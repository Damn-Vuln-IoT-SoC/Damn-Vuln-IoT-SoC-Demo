...
_io = [
    ...
    # JTAG Interface
    ("jtag_tms", 0, Pins("J1"),  IOStandard("LVCMOS33")),
    ("jtag_tdi", 0, Pins("L2"),  IOStandard("LVCMOS33")),
    ("jtag_tdo", 0, Pins("J2"),  IOStandard("LVCMOS33")),
    ("jtag_tck", 0, Pins("G2"),  IOStandard("LVCMOS33")),

    # Keypad
    ("col4", 0, Pins("K17"),  IOStandard("LVCMOS33")),
    ("col3", 0, Pins("M18"),  IOStandard("LVCMOS33")),
    ("col2", 0, Pins("N17"),  IOStandard("LVCMOS33")),
    ("col1", 0, Pins("P18"),  IOStandard("LVCMOS33")),
    ("row4", 0, Pins("L17"),  IOStandard("LVCMOS33")),
    ("row3", 0, Pins("M19"),  IOStandard("LVCMOS33")),
    ("row2", 0, Pins("P17"),  IOStandard("LVCMOS33")),
    ("row1", 0, Pins("R18"),  IOStandard("LVCMOS33")),

    # 7SEG
    ("seg0", 0, Pins("W7"),  IOStandard("LVCMOS33")),
    ("seg1", 0, Pins("W6"),  IOStandard("LVCMOS33")),
    ("seg2", 0, Pins("U8"),  IOStandard("LVCMOS33")),
    ("seg3", 0, Pins("V8"),  IOStandard("LVCMOS33")),
    ("seg4", 0, Pins("U5"),  IOStandard("LVCMOS33")),
    ("seg5", 0, Pins("V5"),  IOStandard("LVCMOS33")),
    ("seg6", 0, Pins("U7"),  IOStandard("LVCMOS33")),

    # AN
    ("an0", 0, Pins("U2"),  IOStandard("LVCMOS33")),
    ("an1", 0, Pins("U4"),  IOStandard("LVCMOS33")),
    ("an2", 0, Pins("V4"),  IOStandard("LVCMOS33")),
    ("an3", 0, Pins("W4"),  IOStandard("LVCMOS33")),

    # Lock State
    ("loop_back_signal",   0, Pins("H1"),  IOStandard("LVCMOS33")),
    ("output_signal",   0, Pins("G3"),  IOStandard("LVCMOS33")),
    ...
    ("spiflash", 0,
        ...
        Subsignal("miso", Pins("B15"), IOStandard("LVCMOS33")),
        Subsignal("mosi", Pins("A16"), IOStandard("LVCMOS33")),
        Subsignal("wp",   Pins("C15"), IOStandard("LVCMOS33")),
        Subsignal("hold", Pins("C16"), IOStandard("LVCMOS33")),
    ),

    ("spiflash4x", 0,
        Subsignal("cs_n", Pins("A14")),
        Subsignal("clk",  Pins("C15")),
        Subsignal("dq",   Pins("C16 A16 B15 A15")),
        IOStandard("LVCMOS33")
    ),
